...
- Name: weather.spec.ts >> Weather E2E >> Weather Alert in Inbox after storm
- Location: src/tests/e2e/weather.spec.ts:150:3
...
Locator: getByText('Message Center')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Message Center')
