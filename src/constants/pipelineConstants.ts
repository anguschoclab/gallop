...
export const PHASE_ORDER_NPC_CAREER_TRACKER = 82;
export const PHASE_ORDER_NPC_MILESTONE_ALERTS = 83;
...
export const PHASE_ORDER_CASH_PRESSURE_HISTORY = 201;
export const PHASE_ORDER_EVENT_TRIGGERS = 202;
