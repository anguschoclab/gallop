    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <Card>
          ...
          <CardContent>
            <p className="text-3xl font-bold tabular-nums">${cash.toLocaleString()}</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-3xl font-bold">{myRunning.length}</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <Card>
          <CardHeader>
            <CardTitle>Top horses</CardTitle>
          </CardHeader>
          <CardContent className="space-y-2">
            ...
            {horses.length === 0 && (
              <p className="text-sm text-muted-foreground">No horses yet — visit the market.</p>
            )}
          </CardContent>
        </Card>
            ...
            {upcoming.map((r) => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Day {r.day} · {r.distance}m · {r.raceClass}
                  </p>
                </div>
