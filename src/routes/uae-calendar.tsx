...
function UAECalendarPage() {
  ...
  const uaeRaces = races.filter((race) =>
    race.graded && UAE_TRACKS.has(race.graded.track)
  );
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">UAE Racing Calendar</h1>
        <p className="text-muted-foreground">Grade 1, 2, and 3 stakes races across the UAE</p>
      </div>
