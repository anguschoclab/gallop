...
export const Route = createFileRoute("/analytics/racing")({
  component: AnalyticsRacing,
});

function AnalyticsRacing() {
  const d = useAnalyticsData();

  // Beyer distribution buckets
  const buckets = [0, 0, 0, 0, 0, 0]; // <60, 60-69, 70-79, 80-89, 90-99, 100+
  d.owned.forEach((h) => {
  ...
  return (
    <div className="space-y-6">
      <BackLink />
      <header>
        <h1 className="font-display text-3xl text-cream">Racing analytics</h1>
