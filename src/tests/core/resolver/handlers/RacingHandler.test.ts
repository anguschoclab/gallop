...
describe("RacingHandler", () => {
  it("race_entry adds entry to race", () => {
    ...
    const impact: RaceEntryImpact = {
      ...
      type: "race_entry", raceId: "race-1", horseId: "h1", jockeyId: "j1", weight: 120,
      entryFee: 1000,
      reason: "Entered race",
    };
  ...
  it("race_withdrawal removes entry from race", () => {
    ...
    const impact: RaceWithdrawalImpact = {
      id: "imp-1", intentId: "", day: 12, phase: "raceResolution", logLevel: "always",
      type: "race_withdrawal", raceId: "race-1", horseId: "h1", refundAmount: 1000, reason: "Withdrawn",
    };
  ...
  it("race_result sets result, resolved, and snapshots", () => {
    ...
    const impact: RaceResultImpact = {
      id: "imp-1", intentId: "", day: 15, phase: "raceResolution", logLevel: "always",
      type: "race_result", raceId: "race-1", results, snapshots, reason: "Race finished",
    };
  ...
  it("jockey_contract sets stableId and contractUntil", () => {
    ...
    const impact: JockeyContractImpact = {
      ...
      type: "jockey_contract", jockeyId: "j1", stableId: "player", contractUntil: 365,
  ...
  it("jockey_assignment updates entry jockeyId", () => {
    ...
    const impact: JockeyAssignmentImpact = {
      id: "imp-1", intentId: "", day: 11, phase: "managementResolution", logLevel: "always",
      type: "jockey_assignment", raceId: "race-1", horseId: "h1", jockeyId: "j2", reason: "Reassigned",
    };
  ...
  it("jockey_silk updates jockey silk", () => {
    ...
    const impact: JockeySilkImpact = {
      id: "imp-1", intentId: "", day: 10, phase: "managementResolution", logLevel: "always",
      type: "jockey_silk", jockeyId: "j1", silk: "#ff0000", reason: "Silk rerolled",
    };
  ...
  it("jockey_stats updates stats and handles apprenticeProgression", () => {
    ...
    const impact: JockeyStatsImpact = {
      id: "imp-1", intentId: "", day: 20, phase: "raceResolution", logLevel: "always",
      type: "jockey_stats", jockeyId: "j1", careerStarts: 30, careerWins: 8, fame: 15,
      apprenticeProgression: {
        jockeyId: "j1", status: "journeyman", careerWins: 8, apprenticeWins: 5, startDate: 1,
      },
  ...
  it("claiming transfers horse ownership", () => {
    ...
    const impact: ClaimingImpact = {
      id: "imp-1", intentId: "", day: 15, phase: "raceResolution", logLevel: "always",
      type: "claiming", raceId: "race-1", horseId: "h1", toStableId: "", claimingPrice: 25000,
  ...
  it("triple_crown_progress creates new entry", () => {
    ...
    const impact: TripleCrownProgressImpact = {
      id: "imp-1", intentId: "", day: 100, phase: "raceResolution", logLevel: "always",
      type: "triple_crown_progress", horseId: "h1", triplecrownKey: "us_3yo", year: 2024,
      legs: [{ raceKey: "race-1", position: 1, day: 50 }], won: false, reason: "Triple crown progress",
    };
  ...
  it("triple_crown_progress updates existing entry", () => {
    ...
    const state = {
      horses: [],
      races: [],
      triplecrownHistory: [{ horseId: "h1", triplecrownKey: "us_3yo", year: 2024, legs: 2, won: false }],
    } as unknown as GameState;

    const impact: TripleCrownProgressImpact = {
      id: "imp-1", intentId: "", day: 120, phase: "raceResolution", logLevel: "always",
      type: "triple_crown_progress", horseId: "h1", triplecrownKey: "us_3yo", year: 2024,
      legs: [{ raceKey: "race-1", position: 1, day: 50 }, { raceKey: "race-2", position: 1, day: 80 }, { raceKey: "race-3", position: 1, day: 120 }],
      won: true, reason: "Triple crown won",
    };
  ...
  it("tactics updates entry jockeyInstructions", () => {
    ...
    const impact: TacticsImpact = {
      id: "imp-1", intentId: "", day: 11, phase: "managementResolution", logLevel: "always",
      type: "tactics", raceId: "race-1", horseId: "h1",
      jockeyInstructions: { horseId: "h1", raceId: "race-1", ridingStyle: "front_runner", earlyPosition: "lead", moveTiming: "early", aggressiveness: 70 },
  ...
  it("race_result_adjustment adjusts and re-sorts results", () => {
    ...
    const state = {
      horses: [],
      races: [{
        id: "race-1", entries: [], resolved: true,
        result: [
    ...
    const impact: RaceResultAdjustmentImpact = {
      id: "imp-1", intentId: "", day: 16, phase: "raceResolution", logLevel: "always",
      type: "race_result_adjustment", raceId: "race-1",
      originalResults: [{ horseId: "h1", position: 1, time: 90 }, { horseId: "h2", position: 2, time: 91 }],
      adjustedResults: [{ horseId: "h1", position: 2, time: 90 }, { horseId: "h2", position: 1, time: 91 }],
      reason: "Stewards DQ",
    };
  ...
  it("jockey_affinity_gain updates affinity map", () => {
    ...
    const impact: JockeyAffinityImpact = {
      id: "imp-1", intentId: "", day: 15, phase: "raceResolution", logLevel: "always",
      type: "jockey_affinity_gain", jockeyId: "j1", horseId: "h1", xp: 10,
