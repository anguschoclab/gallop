...
export const KOPPEN_PROFILES: Record<KoppenCode, ClimateProfile> = {
  Cfb: {
    ...
    monthly: {
      ...
      2: { avgHigh: 8, avgLow: 2, precipDays: 9, precipMm: 45, humidity: 0.8, snowfallDays: 2 },
      ...
      5: { avgHigh: 18, avgLow: 9, precipDays: 9, precipMm: 50, humidity: 0.7 },
      6: { avgHigh: 21, avgLow: 12, precipDays: 9, precipMm: 45, humidity: 0.7 },
      7: { avgHigh: 23, avgLow: 14, precipDays: 8, precipMm: 45, humidity: 0.7 },
      ...
      11: { avgHigh: 11, avgLow: 5, precipDays: 11, precipMm: 65, humidity: 0.8 },
  ...
  Cfa: {
    ...
    monthly: {
      ...
      4: { avgHigh: 20, avgLow: 11, precipDays: 10, precipMm: 120, humidity: 0.7 },
      ...
      10: { avgHigh: 22, avgLow: 14, precipDays: 9, precipMm: 160, humidity: 0.7 },
  ...
  Csa: {
    ...
    monthly: {
      ...
      12: { avgHigh: 16, avgLow: 6, precipDays: 7, precipMm: 50, humidity: 0.7 },
    },
  },
  ...
  Csb: {
    ...
    monthly: {
      1: { avgHigh: 29, avgLow: 14, precipDays: 2, precipMm: 8, humidity: 0.5 },
      ...
      7: { avgHigh: 13, avgLow: 4, precipDays: 11, precipMm: 95, humidity: 0.8 },
      8: { avgHigh: 15, avgLow: 5, precipDays: 10, precipMm: 70, humidity: 0.75 },
      9: { avgHigh: 17, avgLow: 6, precipDays: 7, precipMm: 50, humidity: 0.7 },
      ...
      12: { avgHigh: 28, avgLow: 13, precipDays: 2, precipMm: 10, humidity: 0.5 },
    },
  },
  ...
  BWh: {
    ...
    monthly: {
      1: { avgHigh: 24, avgLow: 14, precipDays: 2, precipMm: 15, humidity: 0.6 },
  ...
  Dfb: {
    ...
    monthly: {
      1: { avgHigh: 2, avgLow: -4, precipDays: 10, precipMm: 40, humidity: 0.8, snowfallDays: 8 },
      ...
      11: { avgHigh: 7, avgLow: 1, precipDays: 10, precipMm: 50, humidity: 0.8, snowfallDays: 3 },
  ...
  Dfa: {
    ...
    monthly: {
      ...
      2: { avgHigh: 3, avgLow: -7, precipDays: 10, precipMm: 55, humidity: 0.7, snowfallDays: 8 },
      ...
      9: { avgHigh: 24, avgLow: 12, precipDays: 9, precipMm: 85, humidity: 0.7 },
  ...
  Aw: {
    ...
    monthly: {
      1: { avgHigh: 24, avgLow: 16, precipDays: 5, precipMm: 40, humidity: 0.7 },
      2: { avgHigh: 25, avgLow: 17, precipDays: 5, precipMm: 45, humidity: 0.7 },
      ...
      12: { avgHigh: 25, avgLow: 17, precipDays: 5, precipMm: 50, humidity: 0.7 },
    },
  },
  ...
  BSk: {
    ...
    monthly: {
      ...
      8: { avgHigh: 34, avgLow: 19, precipDays: 2, precipMm: 10, humidity: 0.4 },
      9: { avgHigh: 28, avgLow: 14, precipDays: 4, precipMm: 25, humidity: 0.5 },
  ...
  ET: {
    ...
    monthly: {
      1: { avgHigh: -10, avgLow: -20, precipDays: 8, precipMm: 25, humidity: 0.7, snowfallDays: 8 },
      2: { avgHigh: -8, avgLow: -18, precipDays: 7, precipMm: 20, humidity: 0.68, snowfallDays: 7 },
      3: { avgHigh: -2, avgLow: -12, precipDays: 8, precipMm: 25, humidity: 0.7, snowfallDays: 8 },
      4: { avgHigh: 5, avgLow: -4, precipDays: 8, precipMm: 25, humidity: 0.72, snowfallDays: 5 },
      5: { avgHigh: 12, avgLow: 2, precipDays: 7, precipMm: 20, humidity: 0.7, snowfallDays: 2 },
      ...
      8: { avgHigh: 17, avgLow: 7, precipDays: 10, precipMm: 55, humidity: 0.8 },
      ...
      12: { avgHigh: -9, avgLow: -18, precipDays: 9, precipMm: 30, humidity: 0.7, snowfallDays: 9 },
    },
  },
};
