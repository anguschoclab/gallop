import type { CoatColor, HorseMarkings, HorseGender, AppearanceDNA, SockHeight } from "@/game/types";
...
const PALETTES: Record<CoatColor, PortraitPalette> = {
  ...
  "dark-bay": {
    ...
    muzzle: "#1a0a04", eye: "#0a0402", skin: "#1f1008", hoof: "#0a0808",
  ...
  black: {
    ...
    muzzle: "#0a0606", eye: "#1a1410", skin: "#1a1410", hoof: "#000000",
  ...
  chestnut: {
    ...
    muzzle: "#7a3418", eye: "#2a1408", skin: "#3a1c10", hoof: "#3a2218",
  ...
  "liver-chestnut": {
    ...
    muzzle: "#3a1808", eye: "#1a0a04", skin: "#2a1408", hoof: "#1f1210",
  ...
  "seal-brown": {
    ...
    muzzle: "#5a3424", eye: "#0a0402", skin: "#180c06", hoof: "#0c0604",
  ...
  gray: {
    ...
    muzzle: "#7a746c", eye: "#1a1410", skin: "#2a2420", hoof: "#5a5450",
  ...
  white: {
    ...
    muzzle: "#f0c8c0", eye: "#1a0a04", skin: "#f0c8c0", hoof: "#bfb6a8",
  ...
  roan: {
    ...
    muzzle: "#5a3a28", eye: "#1a0a04", skin: "#3a2418", hoof: "#2a1f18",
  ...
  palomino: {
    ...
    muzzle: "#a07a3a", eye: "#2a1808", skin: "#5a4020", hoof: "#a08a64",
  ...
  buckskin: {
    ...
    muzzle: "#1a0e08", eye: "#1a0a04", skin: "#2a1810", hoof: "#1a1410",
  ...
  dun: {
    ...
    points: "#1a0e08", mane: "#0a0504", maneShade: "#000000",
    muzzle: "#3a2418", eye: "#1a0a04", skin: "#2a1810", hoof: "#1a1410",
  ...
  grulla: {
    ...
    muzzle: "#2a2018", eye: "#1a0a04", skin: "#1a1410", hoof: "#0a0808",
  ...
  champagne: {
    ...
    muzzle: "#d4a89c", eye: "#5a8aa8", skin: "#d4a89c", hoof: "#a89484",
