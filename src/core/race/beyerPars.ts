/**
 * beyerPars.ts - Beyer figure par recalibration
 *
 * Pure business logic for Beyer par recalibration, including
 * periodic recalibration based on pace samples and recompute functions.
 *
 * Dependencies: @/constants (SEASON_DAYS)
 * Related files: src/core/race/beyer.ts (Beyer calculation logic),
 *   src/game/store/slices/racingSlice.ts (uses these helpers)
 */
