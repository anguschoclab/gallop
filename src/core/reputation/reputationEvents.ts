/**
 * reputationEvents.ts - Applying reputation events to a reputation record
 *
 * Small pure helper that folds one or more reputation events into the
 * player's ManagerReputation, keeping the score clamped, the tier in sync
 * and the event log bounded.
 *
 * Dependencies: @/core/reputation (getReputationTier, ManagerReputation, ReputationEvent)
