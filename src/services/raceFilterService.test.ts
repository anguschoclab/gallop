...
import { getFilteredRaces, getRacesByTrack, getRacesByMonth } from "./raceFilterService";
...
const races: Race[] = [
  ...
  mkRace({ id: "b", day: 15, raceClass: "Stakes", graded: { key: "g2", grade: "G2", track: "Ascot", trackId: "t1", surface: "Turf" } }),
  mkRace({ id: "c", day: 25, raceClass: "Group", graded: { key: "g1", grade: "G1", track: "Newmarket", trackId: "t2", surface: "Turf" } }),
  mkRace({ id: "d", day: 35, raceClass: "Allowance", graded: { key: "g3", grade: "G3", track: "Ascot", trackId: "t3", surface: "Turf" } }),
];
