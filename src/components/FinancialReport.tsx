  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div>
          <h2 className="text-3xl font-bold tracking-tight text-cream font-[family-name:var(--font-display)]">
            Financial Audit
          </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="md:col-span-1 bg-t900 border-gold shadow-lg shadow-gold/5">
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-2xl font-bold text-cream font-mono">
              {formatCurrency(cash)}
            </CardTitle>
          </CardHeader>
        ...
        <Card className="bg-t900 border-gold-muted/30">
          <CardHeader className="pb-2">
            ...
            <CardTitle className="text-2xl font-bold text-success font-mono">
        ...
        <Card
          className={cn(
            "bg-t900 border-gold-muted/30",
            activePeriodData.netProfit >= 0 ? "border-success/30" : "border-destructive/30",
          )}
        >
          <CardHeader className="pb-2">
        ...
        <Card className="bg-t900/50 border-gold-muted/20">
          ...
          <CardContent>
            {incomeBreakdown.length === 0 ? (
              <div className="py-8 text-center text-cream-muted italic text-sm">
      ...
      <Card className="bg-t900 border-gold-muted/20">
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          ...
          <Badge variant="outline" className="text-cream-muted font-mono">
        ...
        <CardContent>
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="text-xs">
                {recentTransactions.map((t, idx) => (
                  <tr
                    key={t.id || idx}
                    className="border-b border-gold-muted/5 hover:bg-t800/40 transition-colors"
                  >
                    ...
                    <td className="py-3">
                      <Badge
                        variant="outline"
                        className="text-[10px] font-medium border-gold-muted/20 text-cream-muted whitespace-nowrap"
                      >
          ...
          {transactions.length > 50 && (
            <p className="text-[10px] text-center text-cream-muted mt-4 italic">
