...
function getBeyerTier(beyer: number): { color: string; label: string } {
  if (beyer >= 100)
    return { color: "bg-purple-500/15 text-purple-700 border-purple-500/30", label: "Elite" };
  if (beyer >= 90)
    return { color: "bg-blue-500/15 text-blue-700 border-blue-500/30", label: "Excellent" };
  if (beyer >= 80)
    return { color: "bg-green-500/15 text-green-700 border-green-500/30", label: "Good" };
  if (beyer >= 70)
    return { color: "bg-yellow-500/15 text-yellow-700 border-yellow-500/30", label: "Fair" };
