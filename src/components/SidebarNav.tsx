    ...
    items: [
      ...
      { to: "/jockeys", label: "Jockeys", icon: User, exact: false },
      {
        ...
        subItems: [
          ...
          { to: "/breeding", label: "Broodmares", icon: Baby, exact: false, search: { tab: "broodmares" } },
          { to: "/breeding", label: "Stallions", icon: Users, exact: false, search: { tab: "stallions" } },
          { to: "/breeding", label: "Sire Watch", icon: BarChart2, exact: false, search: { tab: "sire-watch" } },
          { to: "/breeding", label: "Leaderboards", icon: Trophy, exact: false, search: { tab: "sire-leaderboards" } },
        ],
      },
    ...
    items: [
      {
        ...
        exact: false,
        subItems: [
          { to: "/racing", label: "Calendar", icon: Calendar, exact: false, search: { tab: "calendar" } },
          { to: "/racing", label: "Races", icon: LayoutGrid, exact: false, search: { tab: "races" } },
          { to: "/racing", label: "Browser", icon: Search, exact: false, search: { tab: "browser" } },
          { to: "/racing", label: "Scheduler", icon: Clock, exact: false, search: { tab: "scheduler" } },
        ],
      },
