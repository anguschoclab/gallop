        ...
        <CollapsibleTrigger asChild>
          <CardHeader className="pb-2 cursor-pointer hover:bg-white/[0.02]">
            <div className="flex items-center justify-between">
              ...
              <ChevronDown className={cn("h-4 w-4 text-cream/40 transition-transform", open && "rotate-180")} />
            </div>
          </CardHeader>
        </CollapsibleTrigger>
        <CollapsibleContent>
          <CardContent className="pt-2 space-y-3">
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="rounded border border-white/5 p-2">
                <div className="text-[9px] uppercase tracking-widest font-mono text-cream/40">Range Earnings</div>
              ...
              {!stable.isPlayer && (
                <>
                  <div className="rounded border border-white/5 p-2">
                    <div className="text-[9px] uppercase tracking-widest font-mono text-cream/40">Prestige</div>
                    <div className="font-mono tabular-nums text-cream font-bold mt-0.5">
                      {stable.prestige.toFixed(0)}
                    </div>
                  </div>
                  <div className="rounded border border-white/5 p-2">
                    <div className="text-[9px] uppercase tracking-widest font-mono text-cream/40">Wins vs You</div>
            ...
            {stable.recentResults.length > 0 && (
              <div>
                <div className="text-[9px] uppercase tracking-widest font-mono text-cream/40 mb-1">Recent Results</div>
