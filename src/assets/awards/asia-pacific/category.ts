...
export const categorySvg = `<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <circle cx="24" cy="24" r="22" fill="url(#apac-cat-bg)" stroke="#32CD32" stroke-width="2"/>
  
  <!-- Modern trophy -->
  <path d="M15 16 L17 27 L24 31 L31 27 L33 16 Z" 
        stroke="#FFD700" stroke-width="1.5" fill="none"/>
  <path d="M13 16 L35 16" stroke="#FFD700" stroke-width="1.5"/>
  
  <!-- Angular handles -->
  <path d="M15 18 L11 22 L15 26" stroke="#FFD700" stroke-width="1.5" fill="none"/>
  <path d="M33 18 L37 22 L33 26" stroke="#FFD700" stroke-width="1.5" fill="none"/>
  ...
  <defs>
    <linearGradient id="apac-cat-bg" x1="0" y1="0" x2="48" y2="48">
