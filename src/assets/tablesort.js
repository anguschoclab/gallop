  ...
  fdTableSort = {
    ...
    init: function (tableId) {
      ...
      for (var k = 0, tbl; (tbl = tables[k]); k++) {
        ...
        columnNumSortObj = {};
        colMatch = fdTableSort.parseClassName(
          showOnly ? "sortable-onload-show" : "sortable-onload",
          tbl,
        );
    ...
    prepareTableData: function (table) {
        ...
        for (var tmp = 0, th; (th = sortableColumnNumbers[tmp]); tmp++) {
          ...
          if (th.className.search(/sortable-date/) != -1) {
            ...
            if (th.className.match(/sortable-([a-zA-Z\_]+)/)[1] + "PrepareData" in window) {
              txt = window[th.className.match(/sortable-([a-zA-Z\_]+)/)[1] + "PrepareData"](
                td,
                txt,
              );
            }
      ...
      var colStyle =
        table.className.search(/colstyle-([\S]+)/) != -1
          ? table.className.match(/colstyle-([\S]+)/)[1]
          : false;
      var rowStyle =
        table.className.search(/rowstyle-([\S]+)/) != -1
    ...
    addThNode: function () {
      ...
      if (dataObj.thList.length > 1) {
        classToAdd =
          fdTableSort.thNode.className.search(/forwardSort/) != -1 ? "reverseSort" : "forwardSort";
    ...
    initSort: function (noCallback, ident) {
      ...
      var lastPos =
        dataObj.pos && dataObj.pos.className
          ? dataObj.pos.className.match(/fd-column-([0-9]+)/)[1]
          : -1;
