...
Animation in Gallop has one job: tell the user _something happened_. It is never decoration.
...
**Rule:** the more important the transition, the _longer_ it is, never _flashier_. We don't bounce, spring, or scale-overshoot.
