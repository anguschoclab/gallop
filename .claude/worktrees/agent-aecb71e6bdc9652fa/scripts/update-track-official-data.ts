    ...
    courses: [
      {
        ...
        straightLength: 500,
        width: 30,
        elevationChange: 22.2,
        name: "Straight Mile and Round Course",
      },
    ],
  },
  Newmarket: {
    ...
    courses: [
      {
        ...
        straightLength: 450,
        width: 26,
        elevationChange: 12.0,
        name: "Goodwood Course",
      },
    ],
  },
    ...
    courses: [
      {
        ...
        straightLength: 400,
        width: 25,
        name: "King Abdulaziz Dirt Track",
      },
      {
        surface: "Turf",
        circumference: 2000,
        straightLength: 400,
        width: 28,
        name: "King Abdulaziz Turf Track",
      },
    ],
  },
  ...
  Kranji: {
    courses: [
      ...
      },
      {
        ...
        width: 25,
        elevationChange: 0,
        name: "Kranji Polytrack",
      },
    ],
  },
};

function generateOvalSections(
  circumference: number,
  straightLength: number,
  ...
  return [
    {
      type: "straight",
      length: Math.round(straightLength),
      gradient: Math.round(grad * 100) / 100,
    },
    {
      type: "turn",
      length: Math.round(turnLength),
...
function run() {
  ...
  for (const track of tracks) {
    ...
    if (officialData) {
      ...
      console.log(
        `✅ ${track.name} - ${firstCourse.circumference}m circ, ${firstCourse.straightLength}m straight, ${officialData.courses.length} course(s)`,
      );
