...
export const hotySvg = `<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <circle cx="24" cy="24" r="22" fill="url(#eu-bg)" stroke="#C0C0C0" stroke-width="2"/>
  ...
  <path d="M14 16 L34 16" stroke="#C0C0C0" stroke-width="2"/>
  ...
  <text x="24" y="42" font-size="3" fill="#C0C0C0" text-anchor="middle" font-weight="bold">HOTY</text>
  
  <defs>
    <linearGradient id="eu-bg" x1="0" y1="0" x2="48" y2="48">
