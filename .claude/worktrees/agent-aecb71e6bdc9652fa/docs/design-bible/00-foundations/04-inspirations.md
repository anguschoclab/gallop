...
## *Starters Orders* (4 / 7) — Strategic Designs
...
## *Photo Finish: Horse Racing* — Third Time Games
...
Tiny, joyful, brilliant. The opposite of *Starters Orders*: simplicity as a virtue.
...
- Is there an Asian-market sim peer (e.g. *Derby Stallion*) we should add? It's culturally important to the genre but the team isn't fluent in its UX yet.
