...
export const categorySvg = `<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <circle cx="24" cy="24" r="22" fill="url(#sa-cat-bg)" stroke="#FF6347" stroke-width="2"/>
  
  <!-- Chalice trophy -->
  <path d="M16 17 C16 25 20 29 24 29 C28 29 32 25 32 17" 
        stroke="#FFD700" stroke-width="1.5" fill="none"/>
  <path d="M14 17 L34 17" stroke="#FFD700" stroke-width="1.5"/>
  
  <!-- Handles -->
  <path d="M16 19 C11 21 11 26 16 24" stroke="#FFD700" stroke-width="1.5" fill="none"/>
  <path d="M32 19 C37 21 37 26 32 24" stroke="#FFD700" stroke-width="1.5" fill="none"/>
  ...
  <path d="M34 12 L38 12 M36 10 L36 14" stroke="#8B0000" stroke-width="1"/>
