...
export const hotySvg = `<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <circle cx="24" cy="24" r="22" fill="url(#apac-bg)" stroke="#FFD700" stroke-width="2"/>
  ...
  <path d="M15 15 L17 28 L24 32 L31 28 L33 15 Z" 
        stroke="#FFD700" stroke-width="2" fill="none"/>
  <path d="M13 15 L35 15" stroke="#FFD700" stroke-width="2"/>
  
  <!-- Angular handles -->
  <path d="M15 17 L10 22 L15 27" stroke="#FFD700" stroke-width="2" fill="none"/>
  <path d="M33 17 L38 22 L33 27" stroke="#FFD700" stroke-width="2" fill="none"/>
  ...
  <defs>
    <linearGradient id="apac-bg" x1="0" y1="0" x2="48" y2="48">
