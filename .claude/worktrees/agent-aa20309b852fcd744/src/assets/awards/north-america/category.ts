...
export const categorySvg = `<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <circle cx="24" cy="24" r="22" fill="url(#na-cat-bg)" stroke="#4A90A4" stroke-width="2"/>
  ...
  <path d="M14 14 L34 14" stroke="#C0C0C0" stroke-width="2"/>
  <path d="M18 14 L18 12 C18 11 19 10 20 10 L28 10 C29 10 30 11 30 12 L30 14" 
        stroke="#C0C0C0" stroke-width="2" fill="none"/>
  
  <!-- Handles -->
  <path d="M16 16 C12 16 12 22 16 22" stroke="#C0C0C0" stroke-width="2" fill="none"/>
  <path d="M32 16 C36 16 36 22 32 22" stroke="#C0C0C0" stroke-width="2" fill="none"/>
  ...
  <path d="M36 9 L37 11 L39 11 L37.5 12.5 L38 14.5 L36 13.5 L34 14.5 L34.5 12.5 L33 11 L35 11 Z" fill="#1E3A5F"/>
