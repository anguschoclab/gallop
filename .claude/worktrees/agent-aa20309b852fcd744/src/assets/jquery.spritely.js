    ...
    animate: function (options) {
      ...
      if (options.type == "sprite" && options.fps) {
        ...
        if (!$._spritely.instances[el_id]["_stopped"]) {
          ...
          if (
            (options.do_once && !$._spritely.instances[el_id].remaining_frames) ||
            $._spritely.instances[el_id].remaining_frames <= 0
          ) {
            switch (options.dir) {
              case "up":
          ...
          switch (options.dir) {
            case "up":
              speed *= -1;
            case "down":
              if (!$._spritely.instances[el_id]["l"]) $._spritely.instances[el_id]["l"] = start_x;
              $._spritely.instances[el_id]["t"] = start_y + speed;
              if (options.img_height) $._spritely.instances[el_id]["t"] %= options.img_height;
              break;

            case "left":
              speed *= -1;
            case "right":
              if (!$._spritely.instances[el_id]["t"]) $._spritely.instances[el_id]["t"] = start_y;
              $._spritely.instances[el_id]["l"] = start_x + speed;
              if (options.img_width) $._spritely.instances[el_id]["l"] %= options.img_width;
              break;
          }
      ...
      $._spritely.instances[el_id]["timeout"] = window.setTimeout(
        function () {
    ...
    spStop: function (bool) {
      this.each(function () {
        var $this = $(this),
          el_id = $this.attr("id");
        if (
          typeof $._spritely.instances[el_id]["options"] != "undefined" &&
