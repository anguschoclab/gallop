...
describe("filterRacesByCriteria", () => {
  ...
  it("surface filter: Turf only", () => {
    const turfRace = mkRace({
      id: "turf",
      graded: { key: "t", grade: "G1", track: "A", trackId: "1", surface: "Turf" },
    });
    const dirtRace = mkRace({
      id: "dirt",
      graded: { key: "d", grade: "G1", track: "B", trackId: "2", surface: "Dirt" },
    });
  ...
  it("surface filter: Synthetic only", () => {
    const synthRace = mkRace({
      id: "synth",
      graded: { key: "s", grade: "G1", track: "C", trackId: "3", surface: "Synthetic" },
    });
    const turfRace = mkRace({
      id: "turf",
      graded: { key: "t", grade: "G1", track: "A", trackId: "1", surface: "Turf" },
