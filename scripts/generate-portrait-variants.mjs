...
async function main() {
  ...
  await recolorPortrait('horse-portrait-chestnut.png', 'horse-portrait-liver-chestnut.png', (r, g, b, a) => {
  ...
  await recolorPortrait('horse-portrait-palomino.png', 'horse-portrait-champagne.png', (r, g, b, a) => {
    if (a < 10) return [r, g, b, a];
    const [h, s, l] = rgbToHsl(r, g, b);
