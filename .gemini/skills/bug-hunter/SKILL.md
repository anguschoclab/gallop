---
name: bug-hunter
description: "A systematic debugging workflow to trace, diagnose, and fix bugs from symptoms to root cause. Use when a user reports a bug, an error occurs, or code behavior is unexpected."
---
